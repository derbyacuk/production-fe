...
function stopAnimatingIndicatorWhenScrolled(e) {
    ...
    let scrollIndicator = document.querySelector('.pattern-hero-scroll-to-content-arrow-animate')
    if (scrollIndicator) {
...
let heroElementExistsOnPage = document.querySelector('.pattern-hero') != undefined;
